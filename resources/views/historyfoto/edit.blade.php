<x-app-layout>
    ...
    <div class="p-6 bg-gray-100 dark:bg-gray-900 min-h-screen">
        ...
        <form method="POST" action="{{route('historyfoto.store',['history'=> $history])}}" enctype="multipart/form-data" class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg">
            @csrf
            @method('POST')
            ...
            <input type="hidden" name="history_id" id="history_id" value="{{ request()->history}}">

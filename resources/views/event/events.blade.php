            ...
            <table class="min-w-full bg-white dark:bg-gray-800 rounded-lg shadow-lg">
                <thead>
                    <tr class="bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 text-left">
                        ...
                        <th class="py-5 px-4 border-b">Archiveer</th>
                ...
                <tbody>
                    @foreach ($events as $event)
                        <tr class="bg-white dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700">
                            ...
                            <td class="py-5 px-4 border-b text-white">
                                <a href="{{ route('event.edit', ['event' => $event->id]) }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Bewerken</a>
                            </td>
                            <td class="py-5 px-4 border-b text-white">
                                <form action="{{ route('event.archive', ['event' => $event->id]) }}" method="POST">
                                    @csrf
                                    <input type="submit" value="Archive" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                                </form>
                            </td>

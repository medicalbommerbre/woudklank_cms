...
<x-app-layout>
    ...
    @endif
            ...
            <div class="mb-4">
                <label for="event_date" class="block text-gray-700 dark:text-gray-300 font-bold mb-2">Tijd</label>
                <input type="time" id="event_time" name="event_time" step="60"  value="{{$event->event_time = date('H:i', strtotime($event->event_time));}}" 
                       class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 dark:text-gray-300 dark:bg-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500">
            </div>

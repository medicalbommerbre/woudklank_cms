<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                {{__('Edit foto') }}  {{ $id->archived_event_id}}
            </h2>
    ...
    <div class="p-6 bg-gray-100 dark:bg-gray-900 min-h-screen">
        ...
        <form method="POST" action="{{route('archive.fotoupdate',['id'=> request()->id])}}" enctype="multipart/form-data" class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg">
            @csrf
            @method('PUT')
            ...
            <div class="mb-4">
                ...
                <input type="text" name="caption" id="caption" value="{{ $id->caption}}"
            ...
            <input type="hidden" name="archived_event_id" id="archived_event_id" value="{{ $id->archived_event_id}}">

            <div>
                <input type="submit" value="Edit foto"

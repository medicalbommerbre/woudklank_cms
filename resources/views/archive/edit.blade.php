    ...
    @endif
        ...
        <form method="POST" action="{{route('archive.update',['event'=> $event])}}" enctype="multipart/form-data" class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="event_title" id="event_title" placeholder="Naam" value="{{ $event->event_title }}"
            ...
            <div class="mb-4">
                ...
                <textarea name="event_description" id="event_description" placeholder="Beschrijving"
                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 dark:text-gray-300 dark:bg-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('event_description', $event->event_description) }}</textarea>
            ...
            <div class="mb-4">
                <label for="event_time" class="block text-gray-700 dark:text-gray-300 font-bold mb-2">Tijd</label>
                <input type="time" name="event_time" id="event_time" step="60"  value="{{$event->event_time = date('H:i', strtotime($event->event_time))}}" 
                       class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 dark:text-gray-300 dark:bg-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500">
            </div>

            <div class="mb-4">
                <label for="location" class="block text-gray-700 dark:text-gray-300 font-bold mb-2">Locatie</label>
                <input type="text" name="location" id="location" placeholder="Locatie"  value="{{$event->location}}"
                       class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 dark:text-gray-300 dark:bg-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500">
            </div>

            <div class="mb-4">
                <label for="image_path" class="block text-gray-700 dark:text-gray-300 font-bold mb-2">Foto</label>
                <input type="file" name="image_path" id="image_path"   value="<img src="{{ asset($event->image_path) }} alt="Geen foto" 
